...
static func get_data() -> Dictionary:
	return {
		...
		"stage_select.select_hint": "选择一个关卡开始",
		...
		"pause.armor": "护甲: %d",
		"pause.regen": "回复: %.1f",
		"pause.proj_spd": "弹速: %.2fx",
		"pause.duration": "持续时间: %.2fx",
		"pause.amount": "弹数: +%d",
		"pause.growth": "成长: %.2fx",
		"pause.luck": "幸运: %+.0f%%",
		"pause.greed": "贪婪: %+.0f%%",
		...
		"item.wand_desc": "向最近的敌人发射魔法弹",
		"item.garlic_desc": "伤害附近敌人，降低击退和冻结抗性",
		"item.knife_desc": "朝前方投掷飞刀",
		"item.axe_desc": "向玩家上方投掷弧线下落的斧头",
		"item.firewand_desc": "向随机敌人发射弧形火球",
		...
		"item.cross_desc": "发射带回旋镖效果的旋转十字架",
		"item.bible_desc": "在玩家周围生成旋转的圣经光环",
		"item.santa_water_desc": "从天空降下圣水瓶，落地形成伤害水洼",
		"item.runetracer_desc": "向随机方向发射缓慢移动的弹射物，在墙壁上反弹",
		...
		"enemy.91_name": "死神学徒",
		"enemy.92_name": "未知存在",
		"enemy.93_name": "基础莫利萨诺",
		"enemy.94_name": "干瘪莫利萨诺",
		"enemy.95_name": "美丽莫利萨诺",
		"enemy.96_name": "大个莫利萨诺",
		"enemy.97_name": "黄色莫利萨诺",
		"enemy.98_name": "红色莫利萨诺",
		"enemy.99_name": "豆子莫利萨诺",
		"enemy.100_name": "老莫利萨诺",
		"enemy.101_name": "莫利萨诺之壶",
		"enemy.102_name": "大莫利萨诺",
		"enemy.103_name": "双颅骨",
		"enemy.104_name": "大颅骨",
		"enemy.105_name": "骷髅豹",
		"enemy.106_name": "巨型骷髅",
		"enemy.107_name": "骷髅体",
		"enemy.108_name": "斯凯塔玛利",
		"enemy.109_name": "竹子人",
		"enemy.110_name": "米拉吉洛斯",
		"enemy.111_name": "薄荷元素",
		"enemy.112_name": "疯狂女士",
		"enemy.113_name": "奇祖妮",
		"enemy.114_name": "潜行者",
