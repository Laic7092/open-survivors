...
static func get_data() -> Dictionary:
	return {
		...
		"stage_select.select_hint": "Select a stage to begin",
		...
		"pause.cd": "CD: -%d%%",
		"pause.armor": "Armor: %d",
		"pause.regen": "Regen: %.1f",
		"pause.proj_spd": "Proj Spd: %.2fx",
		"pause.duration": "Duration: %.2fx",
		"pause.amount": "Amount: +%d",
		"pause.growth": "Growth: %.2fx",
		"pause.luck": "Luck: %+.0f%%",
		"pause.greed": "Greed: %+.0f%%",
		"pause.magnet": "Magnet: %.0f",
		"pause.curse": "Curse: %+.0f%%",
		"pause.revivals": "Revives: %d",
		"pause.none": "(none)",
		...
		"item.wand_desc": "Shoots a magic missile at the closest enemy",
		"item.garlic_desc": "Damages nearby enemies, reduces knockback and freeze resistance",
		"item.knife_desc": "Throws projectiles in the faced direction",
		"item.axe_desc": "Throws projectiles above the player that arc downward",
		"item.firewand_desc": "Shoots an arc of fireballs at a random enemy",
		...
		"item.cross_desc": "Shoots a spinning cross at enemies with a boomerang effect",
		"item.bible_desc": "Spawns a ring of orbiting bibles around the player",
		"item.santa_water_desc": "Rains down holy water bottles that create damaging puddles",
		"item.runetracer_desc": "Fires slow-moving runes in random directions that bounce off walls",
		...
		"enemy.36_name": "Sig.ra Rossi",
		"enemy.37_name": "Hag",
		"enemy.38_name": "Nesufritto",
		"enemy.39_name": "Merdusa",
		"enemy.40_name": "Undead Witch",
		"enemy.41_name": "Undead Sassy Witch",
		"enemy.42_name": "Milk Elemental",
		"enemy.43_name": "Merman",
		"enemy.44_name": "Lizard Pawn",
		"enemy.45_name": "Twin Snakes",
		"enemy.46_name": "Lizard Rook",
		"enemy.47_name": "Twin Demons",
		"enemy.48_name": "Jellyfish",
		"enemy.49_name": "Skeleton Ninja",
		"enemy.50_name": "Lost Twin",
		"enemy.51_name": "Melone",
		"enemy.52_name": "Minotaur",
		"enemy.53_name": "Mignotaur",
		"enemy.54_name": "Archon Lancia",
		"enemy.55_name": "Archon Ascia",
		"enemy.56_name": "Skelewing",
		"enemy.57_name": "Tritont",
		"enemy.58_name": "Gallotrice",
		"enemy.59_name": "Big Golem",
		"enemy.60_name": "Sword Guardian",
		"enemy.61_name": "Bloodbath",
		"enemy.62_name": "Skullino",
		"enemy.63_name": "Skulorosso",
		"enemy.64_name": "Scarleton",
		"enemy.65_name": "Dragon Shrimp",
		"enemy.66_name": "Poltergeist",
		"enemy.67_name": "Impefinger",
		"enemy.68_name": "Ghiavolo",
		"enemy.69_name": "Undead Mage",
		"enemy.70_name": "Archon Spada",
		"enemy.71_name": "Archon Disco",
		"enemy.72_name": "Manticore",
		"enemy.73_name": "Meat Golem",
		"enemy.74_name": "Serpentvine",
		"enemy.75_name": "Garlic",
		"enemy.76_name": "Nightshade",
		"enemy.77_name": "Sig.ra Blu",
		"enemy.78_name": "Non-Giant Enemy Crab",
		"enemy.79_name": "Tetrabrachia",
		"enemy.80_name": "Archon Fiamma",
		"enemy.81_name": "Succubus",
		"enemy.82_name": "Archon Rame",
		"enemy.83_name": "Demon Priest",
		"enemy.84_name": "Fallen Cherub",
		"enemy.85_name": "Fallen Cherubbello",
		"enemy.86_name": "Fallen Throne",
		"enemy.87_name": "Archon Oro",
		"enemy.88_name": "Demon Beast",
		"enemy.89_name": "Archdemon",
		"enemy.90_name": "Stage Killer",
		"enemy.91_name": "Reaper Trainee",
		"enemy.92_name": "Unknown",
		"enemy.93_name": "Molisano Base",
		"enemy.94_name": "Molisano Secco",
		"enemy.95_name": "Molisano Bello",
		"enemy.96_name": "Molisano Grosso",
		"enemy.97_name": "Molisano Giallo",
		"enemy.98_name": "Molisano Rosso",
		"enemy.99_name": "Molisano Fagiolo",
		"enemy.100_name": "Molisano Vecchio",
		"enemy.101_name": "Molisano Anfora",
		"enemy.102_name": "Big Molisano",
		"enemy.103_name": "Twin Skulls",
		"enemy.104_name": "Skullone",
		"enemy.105_name": "Skeleton Panther",
		"enemy.106_name": "Giant Skeleton",
		"enemy.107_name": "Skeletone",
		"enemy.108_name": "Sketamari",
		"enemy.109_name": "Bambaman",
		"enemy.110_name": "Miragellos",
		"enemy.111_name": "Menta Elemental",
		"enemy.112_name": "Madd-Onna",
		"enemy.113_name": "Kizzune",
		"enemy.114_name": "The Stalker",
		"enemy.115_name": "The Drowner",
		"enemy.116_name": "The Maddener",
		"enemy.117_name": "The Ender",
		"enemy.118_name": "The Directer",
		"enemy.119_name": "Moongolow Atlantean",
		"enemy.120_name": "Harzia",
		"enemy.121_name": "Flower Wall",
