...
static func _init_meta():
	...
	_meta_cache = [
		...
		{ "id": 6, "type": "Bonus",     "bg_color": Color(0.02, 0.04, 0.15), "time_limit": 900.0,  "move_speed_mod": 1.35,"gold_mod": 1.0, "unlock_req": "clear_stage_5",    "stage_items": [] },
		{ "id": 7, "type": "Challenge", "bg_color": Color(0.06, 0.18, 0.06), "time_limit": 1800.0, "move_speed_mod": 1.25,"gold_mod": 1.0, "unlock_req": "reach_level_40", "stage_items": [] },
		{ "id": 8, "type": "Challenge", "bg_color": Color(0.06, 0.04, 0.08), "time_limit": 1800.0, "move_speed_mod": 1.25,"gold_mod": 1.5, "unlock_req": "reach_level_50", "stage_items": [] },
		{ "id": 9, "type": "Challenge", "bg_color": Color(0.15, 0.02, 0.02), "time_limit": 900.0,  "move_speed_mod": 1.25,"gold_mod": 1.5, "unlock_req": "reach_level_60", "stage_items": [] },
		{ "id": 10,"type": "Bonus",     "bg_color": Color(0.1, 0.12, 0.18),  "time_limit": 1200.0, "move_speed_mod": 1.35,"gold_mod": 1.0, "unlock_req": "clear_stage_3",    "stage_items": [] },
		{ "id": 11,"type": "Bonus",     "bg_color": Color(0.04, 0.1, 0.16),  "time_limit": 1200.0, "move_speed_mod": 1.0, "gold_mod": 1.2, "unlock_req": "clear_stage_4",    "stage_items": [] },
		{ "id": 12,"type": "Bonus",     "bg_color": Color(0.08, 0.12, 0.04), "time_limit": 1200.0, "move_speed_mod": 1.35,"gold_mod": 1.0, "unlock_req": "reach_level_30", "stage_items": [] },
