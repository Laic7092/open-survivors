...
const STAGES = [
	...
	# ═══════════════════════════════════════════════════════
	{
		...
		"stage_items": [
			{"type": 4,  "is_weapon": false, "pos": Vector2(-800, -400)},   # Spinach
			{"type": 21, "is_weapon": false, "pos": Vector2(600, 300)},    # Clover
			{"type": 6,  "is_weapon": false, "pos": Vector2(-200, 700)},   # Hollow Heart
			{"type": 9,  "is_weapon": false, "pos": Vector2(500, -600)},   # Pummarola
		],
	},
	# ═══════════════════════════════════════════════════════
	...
	# ═══════════════════════════════════════════════════════
	{
		...
		"stage_items": [
			{"type": 14, "is_weapon": false, "pos": Vector2(0, -1800)},    # Stone Mask
			{"type": 5,  "is_weapon": false, "pos": Vector2(0, 1200)},    # Empty Tome
		],
	},
	# ═══════════════════════════════════════════════════════
	...
	# ═══════════════════════════════════════════════════════
	{
		...
		"stage_items": [
			{"type": 15, "is_weapon": false, "pos": Vector2(-600, 800)},   # Magnet (Attractorb)
			{"type": 7,  "is_weapon": false, "pos": Vector2(900, -500)},  # Candelabrador
			{"type": 3,  "is_weapon": false, "pos": Vector2(-300, -900)}, # Wings
			{"type": 23, "is_weapon": false, "pos": Vector2(400, 600)},   # Armor
		],
	},
	# ═══════════════════════════════════════════════════════
	#  Stage 4 — Gallo Tower
	# ═══════════════════════════════════════════════════════
	{
		...
		"stage_items": [
			{"type": 24, "is_weapon": false, "pos": Vector2(0, -1500)},   # Bracer
			{"type": 22, "is_weapon": false, "pos": Vector2(0, 1500)},   # Spellbinder
		],
	},
	# ═══════════════════════════════════════════════════════
	...
	# ═══════════════════════════════════════════════════════
	{
		...
		"stage_items": [
			{"type": 8,  "is_weapon": false, "pos": Vector2(-1200, -800)}, # Crown
			{"type": 26, "is_weapon": false, "pos": Vector2(1400, 600)},  # Tiragisú
			{"type": 13, "is_weapon": false, "pos": Vector2(0, 1200)},   # Duplicator
		],
	},
	# ═══════════════════════════════════════════════════════
	...
	# ═══════════════════════════════════════════════════════
	{
		...
		"stage_items": [
			{"type": 4, "is_weapon": false, "pos": Vector2(-800, -300)},
			{"type": 6, "is_weapon": false, "pos": Vector2(600, 200)},
			{"type": 9, "is_weapon": false, "pos": Vector2(-400, 700)},
			{"type": 5, "is_weapon": false, "pos": Vector2(500, -500)},
		],
	},
	# ═══════════════════════════════════════════════════════
	...
	# ═══════════════════════════════════════════════════════
	{
		...
		"stage_items": [
			{"type": 4, "is_weapon": false, "pos": Vector2(-600, 0)},
			{"type": 6, "is_weapon": false, "pos": Vector2(600, 0)},
			{"type": 7, "is_weapon": false, "pos": Vector2(0, -400)},
			{"type": 13, "is_weapon": false, "pos": Vector2(0, 400)},
		],
	},
	# ═══════════════════════════════════════════════════════
	...
	# ═══════════════════════════════════════════════════════
	{
		...
		"stage_items": [
			{"type": 25, "is_weapon": false, "pos": Vector2(-800, -600)},
			{"type": 3, "is_weapon": false, "pos": Vector2(700, 500)},
			{"type": 4, "is_weapon": false, "pos": Vector2(0, -800)},
		],
	},
	# ═══════════════════════════════════════════════════════
	...
	# ═══════════════════════════════════════════════════════
	{
		...
		"stage_items": [
			{"type": 15, "is_weapon": false, "pos": Vector2(-600, 400)},
			{"type": 3, "is_weapon": false, "pos": Vector2(500, -300)},
			{"type": 22, "is_weapon": false, "pos": Vector2(-400, -600)},
		],
	},
	# ═══════════════════════════════════════════════════════
	...
	# ═══════════════════════════════════════════════════════
	{
		...
		"stage_items": [
			{"type": 14, "is_weapon": false, "pos": Vector2(-400, 0)},
			{"type": 13, "is_weapon": false, "pos": Vector2(400, 0)},
			{"type": 8, "is_weapon": false, "pos": Vector2(0, -400)},
		],
	},
]
